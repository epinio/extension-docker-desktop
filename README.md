...
```
helm upgrade --install epinio --create-namespace --namespace epinio --atomic --set global.domain=127.0.0.1.sslip.io https://github.com/epinio/helm-charts/releases/download/epinio-1.14.1/epinio-1.14.1.tgz
```
